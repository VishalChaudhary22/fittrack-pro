  ...
  return (
    <ModalPortal>
      ...
      <div 
        ...
        onClick={handleClose}
      >
        {/* Modal Container — position: relative so child absolute panels stay inside */}
        <div 
          style={{ 
        ...
        >
          ...
          {/* ============================================================
              Add Exercise Sub-Panel — INSIDE the modal container
              position: absolute covers the entire modal content area
              ============================================================ */}
          {addingExercise && (
            <div 
              style={{ 
            ...
            >
              ...
              <div style={{ display: 'flex', padding: '16px 24px', gap: 8, flexShrink: 0 }}>
                {dayDef && <button style={{ flex: 1, padding: '10px', borderRadius: 12, fontSize: 13, fontWeight: 700, border: 'none', background: addingExercise === 'split' ? 'var(--primary)' : 'var(--surface-container)', color: addingExercise === 'split' ? 'var(--on-primary)' : 'var(--on-surface)', cursor: 'pointer' }} onClick={() => setAddingExercise('split')}>From Split</button>}
