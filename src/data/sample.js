...
export const genSample = () => {
  ...
  for (let i = 55; i >= 0; i--) {
    ...
    if (i % 3 === 0 || i < 10) hl.push({ id: gId(), userId: 'vishal', date: localDateStr(d), weight: w, notes: '' });
  }
  const wl = [];
  ...
  for (let w = 0; w < 10; w++) {
    ...
    wl.push({
      id: gId(), userId: 'vishal', splitId: 'ppl', dayId: 'ppl-pa', dayName: 'Push Day A', date: localDateStr(d),
      exercises: [
