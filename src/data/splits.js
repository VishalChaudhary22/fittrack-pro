...
// ─── EXERCISE FACTORIES ───────────────────────────────────────────────────────
const mkLowerA = () => [
  { id: gId(), name: 'Squats', sets: 3, repsRange: '6-8', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '' },
  ...
  { id: gId(), name: 'Standing Calf Raises', sets: 3, repsRange: '15-20', muscle: 'Calves', primaryMuscle: 'calves', secondaryMuscles: [], notes: '' },
];

const mkLowerB = () => [
  { id: gId(), name: 'Leg Press', sets: 3, repsRange: '8-12', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '', variants: ['Leg Press', 'Pendulum Squats'] },
  { id: gId(), name: 'Leg Extension', sets: 3, repsRange: '12-15', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: [], notes: '' },
  { id: gId(), name: 'Romanian Deadlift', sets: 3, repsRange: '10-12', muscle: 'Hamstrings', primaryMuscle: 'hamstrings', secondaryMuscles: ['glutes', 'back'], notes: '' },
  { id: gId(), name: 'Leg Adductor Machine', sets: 3, repsRange: '15-20', muscle: 'Adductors', primaryMuscle: 'quads', secondaryMuscles: [], notes: '' },
  { id: gId(), name: 'Standing Calf Raises', sets: 3, repsRange: '15-20', muscle: 'Calves', primaryMuscle: 'calves', secondaryMuscles: [], notes: '' },
];

const mkUpperA = () => [
  { id: gId(), name: 'Smith Machine Incline Press', sets: 3, repsRange: '8-12', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: ['shoulders', 'triceps'], notes: '' },
  ...
  { id: gId(), name: 'Wide Grip Lat Pulldowns', sets: 3, repsRange: '10-12', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '' },
  ...
  { id: gId(), name: 'Biceps Cable Curls', sets: 2, repsRange: '12-15', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: ['forearms'], notes: '' },
  { id: gId(), name: 'Hammer Curls', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: ['forearms'], sets: 2, repsRange: '12-15', notes: '' },
  { id: gId(), name: 'Single Hand Tricep Pushdowns', sets: 2, repsRange: '12-15', muscle: 'Triceps', primaryMuscle: 'triceps', secondaryMuscles: [], notes: '' },
...
const mkUpperB = () => [
  { id: gId(), name: 'Incline Dumbbell Press', sets: 3, repsRange: '10-12', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: ['shoulders', 'triceps'], notes: '' },
  ...
  { id: gId(), name: 'Close Grip Lat Pulldowns', sets: 3, repsRange: '10-12', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '' },
  { id: gId(), name: 'T-Bar Rows', sets: 3, repsRange: '10-12', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['traps', 'biceps'], notes: '' },
  { id: gId(), name: 'Lateral Raises', sets: 3, repsRange: '15-20', muscle: 'Shoulders', primaryMuscle: 'shoulders', secondaryMuscles: [], notes: '' },
  ...
  { id: gId(), name: 'Incline Bench Bicep Curls', sets: 2, repsRange: '12-15', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: [], notes: '' },
  { id: gId(), name: 'Preacher Curls', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: [], sets: 2, repsRange: '12-15', notes: '' },
  { id: gId(), name: 'Single Hand Overhead Cable Tricep Extension', sets: 2, repsRange: '12-15', muscle: 'Triceps', primaryMuscle: 'triceps', secondaryMuscles: [], notes: '' },
...
export const INIT_SPLITS = [
  ...
  {
    // ─── NEW: Full Body 6-Day (Advanced) ──────────────────────────────────────
    id: 'fb6', name: 'Full Body 6-Day', icon: 'Flame', description: '6 days/week — Full body from every angle', color: '#E8540D',
    tier: 'advanced',
    schedule: ['Push Focus', 'Pull Focus', 'Lower Focus', 'Rest', 'Push Hyp', 'Pull Hyp', 'Lower+Arms'],
    days: [
      {
        id: 'fb6-d1', name: 'Day 1 — Heavy Push', type: 'fullbody', subtype: 'Push Emphasis',
        exercises: [
          { id: gId(), name: 'Barbell Back Squat', sets: 3, repsRange: '5-8', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '' },
          { id: gId(), name: 'Barbell Bench Press', sets: 4, repsRange: '6-8', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: ['triceps', 'shoulders'], notes: '' },
          { id: gId(), name: 'Bent-Over Barbell Row', sets: 3, repsRange: '6-8', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '' },
          { id: gId(), name: 'Dumbbell Shoulder Press', sets: 3, repsRange: '8-10', muscle: 'Shoulders', primaryMuscle: 'shoulders', secondaryMuscles: ['triceps'], notes: '' },
          { id: gId(), name: 'Romanian Deadlift', sets: 2, repsRange: '8-10', muscle: 'Hamstrings', primaryMuscle: 'hamstrings', secondaryMuscles: ['glutes', 'back'], notes: '' },
          { id: gId(), name: 'Cable Triceps Pushdown', sets: 3, repsRange: '10-12', muscle: 'Triceps', primaryMuscle: 'triceps', secondaryMuscles: [], notes: '' },
          { id: gId(), name: 'Standing Calf Raise', sets: 3, repsRange: '10-15', muscle: 'Calves', primaryMuscle: 'calves', secondaryMuscles: [], notes: '' },
        ]
      },
      {
        id: 'fb6-d2', name: 'Day 2 — Heavy Pull', type: 'fullbody', subtype: 'Pull Emphasis',
        exercises: [
          { id: gId(), name: 'Conventional Deadlift', sets: 3, repsRange: '3-6', muscle: 'Back/Hamstrings', primaryMuscle: 'back', secondaryMuscles: ['hamstrings', 'glutes', 'traps'], notes: '' },
          { id: gId(), name: 'Weighted Pull-Up', sets: 3, repsRange: '6-8', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '', variants: ['Weighted Pull-Up', 'Lat Pulldown'] },
          { id: gId(), name: 'Incline Barbell Bench Press', sets: 3, repsRange: '6-8', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: ['shoulders', 'triceps'], notes: '', variants: ['Incline Barbell Bench Press', 'Incline Dumbbell Press'] },
          { id: gId(), name: 'Seated Cable Row', sets: 3, repsRange: '8-10', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '' },
          { id: gId(), name: 'Leg Press', sets: 3, repsRange: '8-10', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '' },
          { id: gId(), name: 'Barbell Curl', sets: 3, repsRange: '8-12', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: ['forearms'], notes: '', variants: ['Barbell Curl', 'Dumbbell Curl'] },
          { id: gId(), name: 'Seated Calf Raise', sets: 3, repsRange: '10-15', muscle: 'Calves', primaryMuscle: 'calves', secondaryMuscles: [], notes: '' },
        ]
      },
      {
        id: 'fb6-d3', name: 'Day 3 — Lower Emphasis', type: 'fullbody', subtype: 'Lower Emphasis',
        exercises: [
          { id: gId(), name: 'Front Squat', sets: 4, repsRange: '6-8', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '', variants: ['Front Squat', 'High-Bar Back Squat'] },
          { id: gId(), name: 'Romanian Deadlift', sets: 3, repsRange: '8-10', muscle: 'Hamstrings', primaryMuscle: 'hamstrings', secondaryMuscles: ['glutes', 'back'], notes: '' },
          { id: gId(), name: 'Walking Dumbbell Lunge', sets: 3, repsRange: '8-10', muscle: 'Quads/Glutes', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '' },
          { id: gId(), name: 'Leg Curl', sets: 3, repsRange: '10-12', muscle: 'Hamstrings', primaryMuscle: 'hamstrings', secondaryMuscles: [], notes: '', variants: ['Seated Leg Curls', 'Lying Leg Curls'] },
          { id: gId(), name: 'Standing Barbell Overhead Press', sets: 3, repsRange: '6-8', muscle: 'Shoulders', primaryMuscle: 'shoulders', secondaryMuscles: ['triceps'], notes: '' },
          { id: gId(), name: 'Chin-Up', sets: 3, repsRange: '8-10', muscle: 'Back/Biceps', primaryMuscle: 'back', secondaryMuscles: ['biceps'], notes: '', variants: ['Chin-Up (Assisted)', 'Chin-Up (Weighted)'] },
        ]
      },
      { id: 'fb6-r', name: 'Rest Day', type: 'rest', exercises: [] },
      {
        id: 'fb6-d4', name: 'Day 4 — Push Hypertrophy', type: 'fullbody', subtype: 'Push Hypertrophy',
        exercises: [
          { id: gId(), name: 'Flat Barbell Bench Press', sets: 3, repsRange: '8-10', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: ['triceps', 'shoulders'], notes: '', variants: ['Flat Barbell Bench Press', 'Flat Dumbbell Press'] },
          { id: gId(), name: 'Incline Dumbbell Press', sets: 3, repsRange: '8-12', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: ['shoulders', 'triceps'], notes: '' },
          { id: gId(), name: 'Machine Shoulder Press', sets: 3, repsRange: '8-12', muscle: 'Shoulders', primaryMuscle: 'shoulders', secondaryMuscles: ['triceps'], notes: '', variants: ['Machine Shoulder Press', 'Dumbbell Shoulder Press'] },
          { id: gId(), name: 'Lateral Raise', sets: 3, repsRange: '12-15', muscle: 'Shoulders', primaryMuscle: 'shoulders', secondaryMuscles: [], notes: '', variants: ['Dumbbell Lateral Raise', 'Cable Lateral Raise'] },
          { id: gId(), name: 'Cable Fly', sets: 3, repsRange: '12-15', muscle: 'Chest', primaryMuscle: 'chest', secondaryMuscles: [], notes: '', variants: ['Cable Fly', 'Pec-Deck Fly'] },
          { id: gId(), name: 'Overhead Triceps Extension', sets: 3, repsRange: '10-12', muscle: 'Triceps', primaryMuscle: 'triceps', secondaryMuscles: [], notes: '', variants: ['Cable Overhead Triceps Extension', 'Dumbbell Overhead Triceps Extension'] },
          { id: gId(), name: 'Leg Extension', sets: 3, repsRange: '10-15', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: [], notes: '' },
        ]
      },
      {
        id: 'fb6-d5', name: 'Day 5 — Pull Hypertrophy', type: 'fullbody', subtype: 'Pull Hypertrophy',
        exercises: [
          { id: gId(), name: 'Chest-Supported Row', sets: 3, repsRange: '8-10', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '', variants: ['Chest-Supported Row', 'Barbell Row'] },
          { id: gId(), name: 'Lat Pulldown', sets: 3, repsRange: '8-12', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '' },
          { id: gId(), name: 'One-Arm Dumbbell Row', sets: 3, repsRange: '8-12', muscle: 'Back', primaryMuscle: 'back', secondaryMuscles: ['biceps', 'traps'], notes: '' },
          { id: gId(), name: 'Face Pull', sets: 3, repsRange: '12-15', muscle: 'Rear Delts', primaryMuscle: 'traps', secondaryMuscles: ['shoulders'], notes: '' },
          { id: gId(), name: 'Hammer Curl', sets: 3, repsRange: '10-12', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: ['forearms'], notes: '' },
          { id: gId(), name: 'EZ-Bar Curl', sets: 3, repsRange: '10-12', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: ['forearms'], notes: '', variants: ['EZ-Bar Curl', 'Cable Curl'] },
          { id: gId(), name: 'Barbell Hip Thrust', sets: 3, repsRange: '8-12', muscle: 'Glutes', primaryMuscle: 'glutes', secondaryMuscles: ['hamstrings'], notes: '', variants: ['Barbell Hip Thrust', 'Machine Hip Thrust'] },
        ]
      },
      {
        id: 'fb6-d6', name: 'Day 6 — Lower + Arms', type: 'fullbody', subtype: 'Lower + Arms/Delts',
        exercises: [
          { id: gId(), name: 'Back Squat', sets: 3, repsRange: '6-10', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '', variants: ['Back Squat', 'Hack Squat'] },
          { id: gId(), name: 'Leg Press', sets: 3, repsRange: '8-12', muscle: 'Quads', primaryMuscle: 'quads', secondaryMuscles: ['glutes', 'hamstrings'], notes: '', variants: ['Leg Press', 'Bulgarian Split Squat'] },
          { id: gId(), name: 'Leg Curl', sets: 3, repsRange: '10-12', muscle: 'Hamstrings', primaryMuscle: 'hamstrings', secondaryMuscles: [], notes: '', variants: ['Seated Leg Curls', 'Lying Leg Curls'] },
          { id: gId(), name: 'Standing Calf Raise', sets: 3, repsRange: '10-15', muscle: 'Calves', primaryMuscle: 'calves', secondaryMuscles: [], notes: '' },
          { id: gId(), name: 'Seated Dumbbell Lateral Raise', sets: 3, repsRange: '12-15', muscle: 'Shoulders', primaryMuscle: 'shoulders', secondaryMuscles: [], notes: '' },
          { id: gId(), name: 'Cable Triceps Pushdown', sets: 3, repsRange: '10-12', muscle: 'Triceps', primaryMuscle: 'triceps', secondaryMuscles: [], notes: '' },
          { id: gId(), name: 'Alternating Dumbbell Curl', sets: 3, repsRange: '10-12', muscle: 'Biceps', primaryMuscle: 'biceps', secondaryMuscles: ['forearms'], notes: '' },
        ]
      },
    ]
  },
