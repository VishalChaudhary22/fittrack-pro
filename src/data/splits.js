...
// ─── EXERCISE FACTORIES ───────────────────────────────────────────────────────
const mkLowerA = () => [
  { id: gId(), name: 'Squats', sets: 4, repsRange: '6-8', muscle: 'Quads', notes: '' },
  { id: gId(), name: 'Leg Extension', sets: 3, repsRange: '12-15', muscle: 'Quads', notes: '' },
  { id: gId(), name: 'Leg Curls', sets: 3, repsRange: '12-15', muscle: 'Hamstrings', notes: '', variants: ['Seated Leg Curls', 'Lying Leg Curls'] },
  { id: gId(), name: 'Leg Abductor Machine', sets: 3, repsRange: '15-20', muscle: 'Abductors', notes: '' },
  { id: gId(), name: 'Standing Calf Raises', sets: 4, repsRange: '15-20', muscle: 'Calves', notes: '' },
];

const mkLowerB = () => [
  { id: gId(), name: 'Leg Press', sets: 4, repsRange: '8-12', muscle: 'Quads', notes: '', variants: ['Leg Press', 'Pendulum Squats'] },
  { id: gId(), name: 'Leg Extension', sets: 3, repsRange: '12-15', muscle: 'Quads', notes: '' },
  { id: gId(), name: 'Romanian Deadlift', sets: 4, repsRange: '10-12', muscle: 'Hamstrings', notes: '' },
  { id: gId(), name: 'Leg Adductor Machine', sets: 3, repsRange: '15-20', muscle: 'Adductors', notes: '' },
  { id: gId(), name: 'Standing Calf Raises', sets: 4, repsRange: '15-20', muscle: 'Calves', notes: '' },
];

const mkUpperA = () => [
  { id: gId(), name: 'Smith Machine Incline Press', sets: 4, repsRange: '8-12', muscle: 'Chest', notes: '' },
  { id: gId(), name: 'Flat Dumbbell Press', sets: 3, repsRange: '10-12', muscle: 'Chest', notes: '' },
  { id: gId(), name: 'Wide Grip Lat Pulldowns', sets: 4, repsRange: '10-12', muscle: 'Back', notes: '' },
  { id: gId(), name: 'Seated Horizontal Row', sets: 3, repsRange: '10-12', muscle: 'Back', notes: '' },
  { id: gId(), name: 'Lateral Raises', sets: 4, repsRange: '15-20', muscle: 'Shoulders', notes: '' },
  { id: gId(), name: 'Biceps Cable Curls', sets: 3, repsRange: '12-15', muscle: 'Biceps', notes: '' },
  { id: gId(), name: 'Single Hand Tricep Pushdowns', sets: 3, repsRange: '12-15', muscle: 'Triceps', notes: '' },
];

const mkUpperB = () => [
  { id: gId(), name: 'Incline Dumbbell Press', sets: 4, repsRange: '10-12', muscle: 'Chest', notes: '' },
  { id: gId(), name: 'Chest Machine Press', sets: 3, repsRange: '10-12', muscle: 'Chest', notes: '' },
  { id: gId(), name: 'Close Grip Lat Pulldowns', sets: 4, repsRange: '10-12', muscle: 'Back', notes: '' },
  { id: gId(), name: 'T-Bar Rows', sets: 4, repsRange: '10-12', muscle: 'Back', notes: '' },
  { id: gId(), name: 'Lateral Raises', sets: 3, repsRange: '15-20', muscle: 'Shoulders', notes: '' },
  { id: gId(), name: 'Rear Delt Flyes', sets: 3, repsRange: '15-20', muscle: 'Rear Delts', notes: '' },
  { id: gId(), name: 'Incline Bench Bicep Curls', sets: 3, repsRange: '12-15', muscle: 'Biceps', notes: '' },
  { id: gId(), name: 'Single Hand Overhead Cable Tricep Extension', sets: 3, repsRange: '12-15', muscle: 'Triceps', notes: '' },
];
